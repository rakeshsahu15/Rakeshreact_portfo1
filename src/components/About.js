...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Rakesh Sahu" },
    { id: 2, title: "Email:", text: "rakeshsahu092334@domain.com" },
    { id: 3, title: "Phone:", text: "+91 9399903956" },
    { id: 4, title: "Linkedin", text: "rakeshsahu15" },
  ]);
  return (
    <div className="about">
